...
const handleProductCreate = async (
  ...
  try {
    ...
    const slug = request_body.payload.product.slug;

    // Handle the async getSingleProduct call properly
    await sleep(60000);
    getSingleProduct(slug, tokenPayload);
    // console.log("payload", request_body.payload);

    // await generateContent(
    //   request_body.payload.product,
    //   tokenPayload[tokenMapping.FB_TOKEN]
    // );
